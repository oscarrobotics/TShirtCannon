...
public class Robot extends IterativeRobot {
    ...
    public static OI oi;
    public static cannonControlSub cannonControlSub;
    public static pneumatics pneumatics;
    public static anglePiston anglePiston;
    public static i2cLEDs i2cLEDs;
	...
	RobotMap.init();
        ...
        cannonControlSub = new cannonControlSub();
    ...
    public void disabledInit() {
        Robot.i2cLEDs.setLEDs((byte)30); // Turns off LEDs once when disabled
    }
}